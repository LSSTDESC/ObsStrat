...
########################################################################################################################
# The script implements depth + ebv cuts on ow6, ow7 coadd data for Y1,3,6,10.
########################################################################################################################
# source sims_maf
...
do
    ...
    do
        ...
        python /global/homes/a/awan/LSST/lsstRepos/ObsStrat/static/depth_cuts/implement_depth_ebv_cuts.py  \
                    --db_path='/global/cscratch1/sd/awan/owsee_dbs/'${owtag}'/'${owtag}'_'${db}'.db' \

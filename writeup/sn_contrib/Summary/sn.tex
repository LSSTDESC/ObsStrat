...
We propose to use as a primary metric the size and depth of a the subset of well-sampled \sne. More precisely, for each proposed observing strategy, the following quantities are estimated:
\begin{itemize}
...
\begin{figure}
    \begin{center}
        %\scalebox{1.}
        \includegraphics[width=0.4\textwidth]{metrics.pdf}

...
b) Season length                & \~ 150 days               & 180 to 200 days \\
...
\begin{figure}[htbp]
  \begin{center}
    \includegraphics[width=0.7\linewidth]{FM_plot_cadence_updated.png}
    \includegraphics[width=0.7\linewidth]{FoM_cadence_updated.png}
    \caption{Cosmology constraints across cadence types: the ellipses in the $w_0-w_a$ plane (top) and the dark energy figure of merit is shown (bottom) are shown.}
    \label{fig:snfom}
  \end{center}
\end{figure}
...
The largest difference in the Figure of Merit \ref{fig:snfom} we find is a factor of two between the highest FoM (kraken\_2035) and the lowest FoM (pontus\_2502). The lowest-performing strategy has two alternating bands in declination, switching in alternate years, which is expect to perform poorly. 

...
\begin{figure}[H]
    \centering
    \begin{subfigure}
        \includegraphics[width=0.8\textwidth]{sn_contrib/figures/photometric_classification_roc_results_ddfY1.png}
        \caption{DDFY1}
        \label{fig:ddfy1}
    \end{subfigure}
    ...
    \begin{subfigure}
        \includegraphics[width=0.8\textwidth]{sn_contrib/figures/photometric_classification_roc_results_ddfY10.png}
        \caption{DDFY10}
        \label{fig:ddfy10}
    \end{subfigure}

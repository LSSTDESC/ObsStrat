...
\begin{figure}[h!]
  \centering
  \includegraphics[scale=0.7]{Rosswog_parameter_dist}
...
\begin{figure}[h!]
    \centering
    \includegraphics[scale=1.0]{both_nz_base_kraken_2026}
    \caption{Example redshift distribution of detected KNe within the sample of all simulated KNe. This distribution is for the `unofficial' project baseline cadence \texit{kraken 2026} for the DES-GW KNe SED model with an inlay of the results for the same cadence for the Rosswog model.}
...
\begin{figure}[h!]
    ...
    \begin{subfigure}
      \centering
      \includegraphics[scale=0.79]{wfd_detection_counts_by_cadence}
    \end{subfigure}
    \begin{subfigure}
      \centering
      \includegraphics[scale=0.79]{ddf_detection_counts_by_cadence}
    \end{subfigure}

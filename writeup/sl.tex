...
\end{tabular}
\caption{This table shows the fraction of systems of the 202 investigated mock systems where the time delay has been measured with accuracy smaller than 1 percent and precision smaller than 5 percent. These are not the final results as the total number of detected LSNe Ia is not taken into account. \todo{Simon}{include 4 new cadence strategies*}}
